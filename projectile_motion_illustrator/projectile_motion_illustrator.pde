...
void setup() {
  ...
  background_img = loadImage("https://live.staticflickr.com/65535/51665378972_c0c3ee7168_o.png");
  background_img.resize(width, height);
  ball = loadImage("https://live.staticflickr.com/65535/51665385777_b9057c6060_o.png");
  ball.resize(radi*2, radi*2);
}
void draw() {
  data();
  backGround();
